...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se o objetos tem 3 propriedades', () => {
    expect(Object.keys(circle(3)).length).toBe(3);
  });
  it('Verifica se a função não receber parametro retorna undefined', () => {
    expect(circle()).toBeUndefined();
  });
  it('Verifica se entro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2', () => {
  ...
  it('função retorna, em um objeto, os dados corretos de um círculo de raio 3', () => {
